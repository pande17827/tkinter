...
CREATE TABLE `stdattendance` (
  `std_id` int NOT NULL,
  `std_roll_no` varchar(255) DEFAULT NULL,
  `std_name` varchar(255) DEFAULT NULL,
  `std_time` varchar(255) DEFAULT NULL,
  `std_date` varchar(255) DEFAULT NULL,
  `std_attendacne` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`std_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-12-20 18:32:09
