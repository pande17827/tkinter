...
# This part is image labels setting start 
        ...
        dev_b1 = Button(bg_img,image=self.dev_img1,command=self.developr,cursor="hand2",)
        dev_b1.place(x=710,y=330,width=180,height=180)

        dev_b1_1 = Button(bg_img,text="Developers",command=self.developr,cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
