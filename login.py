...
# This part is image labels setting start 
        ...
        hlp_b1 = Button(bg_img,image=self.hlp_img1,command=self.help,cursor="hand2",)
        hlp_b1.place(x=940,y=100,width=180,height=180)

        hlp_b1_1 = Button(bg_img,text="Help Support",command=self.help,cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"Images_GUI\data.png")
        ...
        exi_b1 = Button(bg_img,image=self.exi_img1,command=self.exit,cursor="hand2",)
        exi_b1.place(x=940,y=330,width=180,height=180)

        exi_b1_1 = Button(bg_img,text="Exit",cursor="hand2",command=self.exit,font=("tahoma",15,"bold"),bg="white",fg="navyblue")
